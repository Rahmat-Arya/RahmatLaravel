...
class AnggotaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()
            ->route('anggota.index')
            ->with('success', 'Data Anggota & Kartu berhasil disimpan!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()
            ->route('anggota.index')
            ->with('success', 'Data Anggota & Kartu berhasil diperbarui!');
    }
    ...
    public function destroy($id)
    {
        ...
        // Otomatis menghapus kartu karena cascade constraint
        $anggota->delete();
